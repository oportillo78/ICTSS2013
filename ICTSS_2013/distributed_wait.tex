...
\title{An automated approach to apply idle-time analysis efficiently in a
performance testing scenario}

% a short form should be given in case it is too long for the running head
\titlerunning{PENDING 1}
...
•IBM WebSphere Portal Server 8.0.1:
...
This section presents a case study adapted from XXX and initially discussed 
in XXX. The JPetStore is a XXXX. This section summarizes a case study
whose purpose is to illustrate through a practical example the application of the principles described in Section 3.
It is worthy mentioning that performance testing attributes/factors have been
included as constants, in order to be realistic they were suggested (as per
their expert judgment) by our industrial partner as valid in a realistic test
environment. The selection of the best values for these attributes is outside
...
[[PENDING: To append results from excel file, they should include some tables
...
In this paper, software performance is understood as the sum of all the
activities involved in the evaluation of how the system can be expected to
perform in the field. Moreover, it is considered from a user's perspective.
It is typically assessed in terms of throughput, stimulus response time, or some
...
KEY METRICS: 
Qualitative: Possible verbiage about how the detected adoption
